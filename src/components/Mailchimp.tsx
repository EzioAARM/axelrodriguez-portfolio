...
import { mailchimp, getHomePageContent } from "@/resources";
...
export const Mailchimp: React.FC<React.ComponentProps<typeof Column>> = ({
    ...
    const [homeContent, setHomeContent] = React.useState<Home | null>(null);
    ...
    if (homeContent?.newsletter.display === false) return null;
...
function setHomeContent(content: Home) {
